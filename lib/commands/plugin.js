...
const cmd = {
  ...
  builder: function(yargs) {
    return yargs
      ...
      .example(chalk.yellow('leetcode plugin cache'), 'Show cache plugin')
      .example(chalk.yellow('leetcode plugin cache -c'), 'Show config of cache plugin')
      .example('', '')
      .example(chalk.yellow('leetcode plugin -i'), 'Install all missing plugins from GitHub')
      .example(chalk.yellow('leetcode plugin -d cache'), 'Disable cache plugin')
      .example(chalk.yellow('leetcode plugin -e cache'), 'Enable cache plugin')
      .example(chalk.yellow('leetcode plugin -D cache'), 'Delete cache plugin');
  }
};
